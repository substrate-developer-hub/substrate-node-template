...
/// Import the supply chain management pallet.
pub use pallet_supply_chain_management;
...
/// Configure the pallet-supply-chain-management in pallets/supply_chain_management.
