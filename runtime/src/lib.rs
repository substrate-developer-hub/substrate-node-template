...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("solochain-veles-runtime"),
	impl_name: create_runtime_str!("solochain-veles-runtime"),
	authoring_version: 1,
