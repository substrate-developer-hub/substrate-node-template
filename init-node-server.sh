...
plenitud key insert --base-path /data/node01 --scheme Ecdsa --suri "vacuum mandate digital voice play control another milk attitude install diary shield" --password $PASSWORD --key-type aura
